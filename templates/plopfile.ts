  ...
  plop.setGenerator('component', {
    ...
    actions: [
      ...
      },
      {
        ...
        templateFile: path.resolve(__dirname, './component/comp.hbs'),
      },
      {
        type: 'add',
        path: path.resolve(__dirname, '../components/{{kebabCase name}}/style/index.less'),
        templateFile: path.resolve(__dirname, './component/style/style.hbs'),
      },
      {
        type: 'add',
        path: path.resolve(__dirname, '../components/{{kebabCase name}}/style/index.ts'),
        templateFile: path.resolve(__dirname, './component/style/index.hbs'),
      },
      {
        type: 'add',
        path: path.resolve(__dirname, '../components/{{kebabCase name}}/index.md'),
        templateFile: path.resolve(__dirname, './component/doc.hbs'),
      },
      {
        type: 'add',
        path: path.resolve(__dirname, '../components/{{kebabCase name}}/interface.ts'),
        templateFile: path.resolve(__dirname, './component/interface.hbs'),
      },
      {
        type: 'add',
        path: path.resolve(__dirname, '../components/{{kebabCase name}}/demo/basic.tsx'),
        templateFile: path.resolve(__dirname, './component/demo/basic.hbs'),
      },
      {
        type: 'add',
        path: path.resolve(__dirname, '../components/{{kebabCase name}}/__tests__/index.test.tsx'),
        templateFile: path.resolve(__dirname, './component/__tests__/index.test.hbs'),
      },
      {
        type: 'append',
